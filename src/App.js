...
const  App=()=> {
  ...
  const [progress,setProgress] = useState(0)
    ...
    return (
      ...
      />
       <Routes>
          <Route exact path="/about"element={<News setProgress={setProgress} apiKey={apiKey} key="science" pageSize={pageSize} country="in" category="science"/>}/>
         ...
         { <News setProgress={setProgress} apiKey={apiKey}  key="health"pageSize={pageSize} country="in" category="health"/>}/>
          ...
          <Route exact path="/"
          element={<News setProgress={setProgress} apiKey={apiKey} key="default" pageSize={pageSize} country="in" category="general"/>}/>
